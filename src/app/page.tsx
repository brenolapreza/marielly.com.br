          ...
          <div className="w-full container flex flex-col md:flex-row md:gap-8 gap-8 justify-center md:justify-between p-8 md:py-16">
            ...
            <div className="flex flex-col gap-4 md:gap-2 items-center">
              ...
              <p className="text-primary">
                ...
                escuta empática e sem julgamentos, proporcionando acolhimento e
                suporte psicológico necessário para que, juntas, possamos
              ...
              <div className="flex flex-col w-[320px] items-center">
                ...
                <div className="bg-secondary p-4 h-full">
                  <span className="text-primary">
                    Meu objetivo é oferecer um atendimento humanizado, com uma
                    escuta empática e sem julgamentos, proporcionando
                    acolhimento e suporte psicológico necessário para que,
                    juntas, possamos encontrar as melhores estratégias para
                    superar as dificuldades que te afligem e promover mais
                    clareza, equilíbrio e qualidade de vida.
                  </span>
                </div>
              </div>
              <div className="flex flex-col w-[320px] items-center">
